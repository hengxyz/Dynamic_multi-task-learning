...
def inference_cari(net, keep_probability, phase_train=True, weight_decay=0.0, reuse=None):
    batch_norm_params = {
    ...
    with slim.arg_scope([slim.conv2d],
        ...
        return inception_resnet_v1_cari(net, is_training=phase_train,
              dropout_keep_prob=keep_probability, reuse=reuse)


def inception_resnet_v1_cari(net, is_training=True,
                                        dropout_keep_prob=1.0,
                                        reuse=None,
                                        scope='InceptionResnetV1_cari'):
    ...
    with tf.variable_scope(scope, 'InceptionResnetV1_cari', [net], reuse=reuse):

...
def main(args):
    ...
    if args.evaluate_express:
        ...
        #loss_expr_percentage_softmax = tf.reduce_mean(softmax_lossweights[:, 1])
        #loss_expr_percentage = tf.minimum(loss_expr_percentage_softmax, 0.99)
        ...
        vars = update_gradient_vars_verif + update_gradient_vars_expr
        train_op_mainstem, grads_full, grads_clip_full = train_BP.train(loss_full, global_step, args.optimizer,
        ...
        if (batch_number % 100 == 0):
            ...
            learning_rate_dyn_, summary_str \
                = sess.run([loss_verif, loss_expr, global_step, regularization_losses,
                            ...
                            grads_clip_full, train_op_weights, logits_lossweights_embedings, learning_rate_dyn, summary_op], feed_dict=feed_dict)
            ...
            learning_rate_dyn_\
                = sess.run([loss_verif, loss_expr, global_step, regularization_losses,
                            ...
                            cross_entropy_verif, diff_mean,centers, train_op_mainstem, loss_verif_percentage,
                            loss_expr_percentage, loss_for_weights, loss_full,grads_full,
                            grads_clip_full, train_op_weights, logits_lossweights_embedings,learning_rate_dyn], feed_dict=feed_dict)
        print("step %d"%step)
